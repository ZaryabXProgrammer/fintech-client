            ...
            <div className="container mx-auto px-6 relative z-10">
                <div className="flex flex-col lg:flex-row items-center justify-between gap-10">
                    ...
                    >
                        ...
                        >
                            Build, test, and launch financial apps with powerful mock APIs gated by real-time subscription logic — JWT-secured and developer-ready.
                        </motion.p>
                        ...
                        >
                            <Link to={username ? '/dashboard' : '/register'} className="bg-themeGreen text-black rounded-full px-8 py-3 font-medium hover:bg-themeGreen/90 transition-all duration-300 transform hover:scale-105 flex items-center gap-2">
                                Get Started
                            ...
                            <Link to='/pricing' className="bg-transparent border-2 border-themeGreen text-white rounded-full px-8 py-3 font-medium hover:bg-themeGreen/10 transition-all duration-300">
                                Pricing
                            </Link>
                        </motion.div>
                        ...
                        >
                            <div className="flex -space-x-2">
                                {[1, 2, 3, 4].map(i => (
                                    <div key={i} className={`w-8 h-8 rounded-full border-2 border-themeGreen bg-gray-800`}></div>
                                ))}
                            </div>
                            <div className="text-white/80 text-sm">
                                <span className="text-themeGreen font-semibold">Built for Devs</span> with seamless API access & RBAC control
                            </div>
                        </motion.div>
                    </motion.div>
                    ...
                    >
                        ...
                        >
                            <div className="p-4 h-full flex flex-col justify-between">
                                <div className="flex justify-between items-start">
                                    <span className="text-black font-semibold">finconnect
</span>
                                    <div className="w-8 h-5 rounded-sm bg-gradient-to-r from-yellow-500 to-yellow-300"></div>
                                </div>
                        ...
                        >
                            <div className="p-4 h-full flex flex-col justify-between">
                                <div className="flex justify-between items-start">
                                    <span className="text-white font-semibold">finconnect
</span>
