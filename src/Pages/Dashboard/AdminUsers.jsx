...
import { Search, Edit2, Trash2, UserPlus, MoreHorizontal } from 'lucide-react';
...
const AdminUsers = () => {
  ...
  const users = [
    { id: 1, name: 'John Smith', email: 'john.smith@example.com', status: 'active', plan: 'pro', joinedDate: '2025-01-15' },
    { id: 2, name: 'Sarah Johnson', email: 'sarah.j@example.com', status: 'active', plan: 'basic', joinedDate: '2025-02-03' },
    { id: 3, name: 'Michael Brown', email: 'michael.b@example.com', status: 'inactive', plan: 'pro', joinedDate: '2024-11-21' },
    { id: 4, name: 'Emily Davis', email: 'emily.d@example.com', status: 'active', plan: 'enterprise', joinedDate: '2025-03-07' },
    { id: 5, name: 'Robert Wilson', email: 'robert.w@example.com', status: 'pending', plan: 'basic', joinedDate: '2025-04-01' },
    { id: 6, name: 'Jennifer Taylor', email: 'jennifer.t@example.com', status: 'active', plan: 'pro', joinedDate: '2025-01-30' },
    { id: 7, name: 'David Martinez', email: 'david.m@example.com', status: 'inactive', plan: 'basic', joinedDate: '2024-12-12' },
    { id: 8, name: 'Lisa Anderson', email: 'lisa.a@example.com', status: 'active', plan: 'enterprise', joinedDate: '2025-02-18' },
  ];
  ...
  const getStatusColor = (status) => {
    switch (status) {
      ...
      case 'inactive': return 'bg-red-500/20 text-red-400 border border-red-500/20';
      case 'pending': return 'bg-yellow-500/20 text-yellow-400 border border-yellow-500/20';
      default: return 'bg-gray-700/30 text-gray-300 border border-gray-500/20';
    }
  };
  ...
  const getPlanColor = (plan) => {
    switch (plan) {
      case 'basic': return 'bg-blue-500/20 text-blue-400 border border-blue-500/20';
      case 'pro': return 'bg-purple-500/20 text-purple-400 border border-purple-500/20';
      case 'enterprise': return 'bg-themeGreen/20 text-themeGreen border border-themeGreen/20';
      default: return 'bg-gray-700/30 text-gray-300 border border-gray-500/20';
    }
  };
    ...
    >
      ...
      >
        ...
        >
          ...
          <p className="text-xl md:text-3xl font-bold text-themeGreen">8</p>
        </motion.div>
        ...
        >
          ...
          <p className="text-xl md:text-3xl font-bold text-green-400">5</p>
        </motion.div>
        ...
        >
          ...
          <p className="text-xl md:text-3xl font-bold text-purple-400">3</p>
        </motion.div>
        ...
        >
          ...
          <p className="text-xl md:text-3xl font-bold text-blue-400">2</p>
        </motion.div>
      </motion.div>
              ...
              <tbody>
                {filteredUsers.map((user, index) => (
                  ...
                  >
                    ...
                    <td className="py-4 px-4 text-gray-300">{user.joinedDate}</td>
                    <td className="py-4 px-4">
